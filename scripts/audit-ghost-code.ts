...
const QUAR_DIR = "scripts/quarantine";
...
await Deno.writeTextFile(`${AUDIT_DIR}/ghost-code.json`, JSON.stringify(report, null, 2));

console.log(`👻 Found ${ghosts.length} ghost file(s)`);
