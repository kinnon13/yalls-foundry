...
await Deno.writeTextFile(`${AUDIT_DIR}/deep-duplicates.json`, JSON.stringify(report, null, 2));

console.log(`📊 Found ${duplicateFamilies.length} duplicate families, ${multiRoleFeatures.length} multi-role features`);
...
// Auto-generate routers for multi-role features
let created = 0;
