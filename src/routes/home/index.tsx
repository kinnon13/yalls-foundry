  ...
  return (
    <>
      ...
      <main className={cn(mobileView === 'feed' ? 'pt-0 pb-16' : 'pt-14 pb-16')}>
        ...
        <div className="hidden lg:grid grid-cols-[360px_1fr_360px] h-[calc(100dvh-112px)] gap-12 px-0 py-8 bg-gradient-to-br from-muted/40 via-muted/30 to-background/95">
