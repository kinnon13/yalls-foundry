  ...
  const phases: ScalingPhase[] = [
    {
      ...
      criticalIssues: [],
      completed: [
        'Multi-tenant RLS with JWT tenant_id',
        'Distributed Redis cache (Upstash)',
        'Rate limiting on all edge functions',
        'PII-safe structured logging',
        'Tenant-isolated CRM intake (/crm-track)',
        'Audit trail with tenant enforcement',
        'Idempotency keys for mutations',
        'NOT NULL constraints on tenant_id',
        'Horizontal scalability ready',
      ],
      remaining: [
        'Migrate remaining console.* to logger',
        'Update all insert/update to use tInsert/tUpdate',
        'Add tenant_id to JWT on sign-in',
      ],
      monthlyCost: '$50-200',
    },
    {
